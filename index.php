  ...
  <div class="page-in">
	...
	<div class="clear"></div>
        <div id="content" style= "margin-top: 30px;">
          <ul>
            <? if ($pt_facebook) { ?>
            <li><a href="<?php echo $pt_facebook; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/facebook.png" /></a></li>
            <? } else { ?>
            <? } ?>

            <? if ($pt_twitter) { ?>
            <li><a href="<?php echo $pt_twitter; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/twitter.png" /></a></li>
            <? } else { ?>
            <? } ?>
            
            <? if ($pt_gplus) { ?>
            <li><a href="<?php echo $pt_gplus; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/googleplus.png" /></a></li>
            <? } else { ?>
            <? } ?>

            <? if ($pt_linkedin) { ?>
            <li><a href="<?php echo $pt_linkedin; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/linkedin.png" /></a></li>
            <? } else { ?>
            <? } ?>
            ...
            <? if ($pt_github) { ?>
            <li><a href="<?php echo $pt_github; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/github.png" /></a></li>
            <? } else { ?>
            <? } ?>

            <? if ($pt_lastfm) { ?>
            <li><a href="<?php echo $pt_lastfm; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/lastfm.png" /><strong>Last.fm</strong>last.fm</a></li>
            <? } else { ?>
            <? } ?>
            ...
            <? if ($pt_foursquare) { ?>
            <li><a href="<?php echo $pt_foursquare; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/foursquare.png" /><strong>Foursquare</strong>foursquare.com</a></li>
            <? } else { ?>
            <? } ?>

            <? if ($pt_snemail) { ?>
            <li><a href="<?php echo $pt_snemail; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/email.png" /></a></li>
            <? } else { ?>
            <? } ?>

            <? if ($pt_snskype) { ?>
            <li><a href="<?php echo $pt_snskype; ?>" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/icons/skype.png" /><strong>Skype</strong>skype.com</a></li>
            <? } else { ?>
            <? } ?>
          </ul>
